function [trlProps, results, eyeData, evTimes, goodTrlIdx] = foragingAnalysisOLD%(folderPath), ...
                                                                             % ou só via foragingParams ele 
                                                                             % pode pegar o nome da pasta
    % Convenção:
    ...
    clear
    edf = edfmex('e00_01_v1.edf');
    mat = load('s00_01_v1.mat');
    ...
    [trlProps, eyeData, evTimes] = foragingTrlProps(mat, edf);
    ...
    P3minDur = 0.025; P3maxDur = 0.180; maxOffset = .05;
    nTrl = numel(trlProps); 

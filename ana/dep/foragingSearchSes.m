function nums = foragingSearchSes(subj, outFolder, params)

    prefix = [params.matPreffix sprintf('%02d', subj) '_'];
    files = dir(fullfile(outFolder, [prefix '*' params.matExtension]));

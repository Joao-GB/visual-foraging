            ...
            try
                ...
                if isfield(prevData.tkP,'fixProps') && ...
                   isfield(prevData.tkP.fixProps,'emaFix')
                    val_emaFix = prevData.tkP.fixProps.med(end);
...
%         stairBurnIn = 1;
    ...
    params.stimSTDmult  = grey* params.stimRMScontrast;
...
function [gabor, matrices] = foragingGabor(screenRes, nStims, params, monitorW_mm, gaborAngle)
    ...
    for i = 1:nStims
        ...
        maux = CreateGrating(gaborSize_px,gaborFreq,gaborAngle(i),rand,1); % matrices(:, colRange) = CreateGrating(gaborSize_px,gaborFreq,gaborAngle(i),rand,1);
